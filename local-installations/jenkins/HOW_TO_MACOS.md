...
Also, in order to perform operations on the local K8s cluster from Jenkins, a kubeconfig file was created by connecting to the Minikube K8s cluster from the local machine. 
...
Here is the list of Jenkins plugins installed for this project:
 ...
 - Jenkins JSch dependency plugin jsch:0.1.55.2
 - Jenkins Workspace Cleanup Plugin ws-cleanup:0.38
 ...
 - Jenkins Apache HttpComponents Client 4.x API Plugin apache-httpcomponents-client-4-api:4.5.13-1.0
 - Jenkins Cobertura Plugin cobertura:1.16
 - Jenkins Parameterized Trigger plugin parameterized-trigger:2.39
 ...
 - Jenkins Mailer Plugin mailer:1.32.1
 - Jenkins Git plugin git:4.5.2
 ...
 - Forensics API Plugin forensics-api:0.9.1
 ...
 - Analysis Model API Plugin analysis-model-api:9.6.0
 ...
 - Jenkins Git client plugin git-client:3.6.0
 ...
 - Jenkins Violations plugin violations:0.7.11
 ...
 - Jenkins GIT server Plugin git-server:1.9
 ...
 - Jenkins Design Language jenkins-design-language:1.24.4
 ...
 - Jenkins Pub-Sub "light" Bus pubsub-light:1.13
 ...
 - Warnings Next Generation Plugin warnings-ng:8.7.0
